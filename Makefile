...
build: tidy # 编译源码，依赖 tidy 目标自动添加/移除依赖包.
	@go build -v -ldflags "$(GO_LDFLAGS)" -o $(OUTPUT_DIR)/mh-apiserver $(PROJ_ROOT_DIR)/cmd/mh-apiserver/main.go
...
VERSION_PACKAGE=github.com/xiahuaxiahua0616/minehub/pkg/version
## 定义 VERSION 语义化版本号
